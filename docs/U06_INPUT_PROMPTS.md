# U06-b: framework input prompts

Status: **implementation, scoped validation, C and P PASS; full U06 IN_PROGRESS**. Owning source is
`d8e6eb7f6840a99afde371db33bee6a16ed0f2a9` on `codex/u06-input-prompts`.
...
collection-row prompts and the remaining theme families remain open under full U06.
