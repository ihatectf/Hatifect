...
Статус: **IN_PROGRESS**. F13-a опубликован в [`7d62ab5`](https://github.com/ihatectf/Hatifect/commit/7d62ab509ac6987df76938c4f34612669b3de16f), база — `203788f71da542470450e1b6aebf69f4a17135fb`, ветка `feature/flow-f13-actions`. Эта запись описывает проверенный объём consumer implementation и оставшуюся приёмку; полный F13 ещё не завершён.
