...
Последовательность работы и условия завершения — в [плане разработки](ROADMAP.md). После законченного изменения обновляй соответствующую карточку: статус, коммит и результаты проверок, ограничения и следующий доступный шаг. Продолжение согласованной задачи не требует повторного согласования.
...
Следующую задачу выбирай по [плану разработки](ROADMAP.md): там указаны понятные названия, зависимости, необходимые решения и короткий формат передачи работы. План описывает оставшуюся разработку, архитектура — действующее устройство системы, технические отчёты — результаты конкретных проверок. Не используй старый «следующий шаг» из отчёта как новую очередь.
