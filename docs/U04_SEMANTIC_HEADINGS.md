...
[Общая alpha.47 integration evidence и ограничения](U03_U04_F12_ALPHA47_INTEGRATION.md). GQ включает этот source в локальный candidate; окончательная общая приёмка выполняется после native glyph correction.
