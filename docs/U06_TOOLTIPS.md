# U06-e semantic tooltips

Source: `1e0a660a3c1b21f42e78cd9430c35a7b82430ad5` on local branch
`feature/u06-tooltips`. This slice is local only and has not been pushed.
...
families, and the full EN/RU/scale/controller consumer matrix keep U06 `IN_PROGRESS`.
