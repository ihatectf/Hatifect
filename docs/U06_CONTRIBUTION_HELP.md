# U06-h semantic contribution help

Source: `a2fe8c84c70119c3708145587e3be8ee06015aab` on local branch
`feature/u06-contribution-help`. This slice is local only and has not been pushed.
...
tokens and frame-only selection reuse the U06-e overlay policy. Contribution ordering, availability,
