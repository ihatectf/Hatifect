...
Проверенный source: `925345c90808697dc9881cf70c6c34afdb528ef8`. Это общая интеграция завершённого U03, U05-a/b/c, исправления SDK source identity и bounded role-label cache. Полные U05, Q01 и F13 остаются IN_PROGRESS. Ветка codex/hatifect-roadmap опубликована; публикация develop ещё предстоит.
