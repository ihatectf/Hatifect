# U06-k semantic validation error help

Source: `338e1c0111e177148e80b23ca32b4f8e1af58e93` on local branch
`feature/u06-validation-help`. This slice is local only and has not been pushed.
...
Keyboard and controller focus expose the current error immediately. Pointer help follows the U06-j
...
open, so U06 remains `IN_PROGRESS`.
