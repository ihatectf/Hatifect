...
The subsequent [capture correction](Q01_CAPTURE_FIX.md) and [HUD-overlay fixture correction](Q01_OVERLAY_FIXTURE.md) have their own fresh C/G/P/runtime evidence. Next: address the separate viewport/composition and visual-matrix observations. Full Q01 remains IN_PROGRESS while these gaps are unresolved. The baseline above remains attached to `7a9e590` when newer Flow/UI changes are integrated.
