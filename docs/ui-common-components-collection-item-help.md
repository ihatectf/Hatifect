...
Recorded source: `35dc94660415e2f31c6d6110b0339c4b17856e78` on the then-local branch
`feature/u06-collection-help`. At the time of this report, the slice had not been pushed.
...
theme tokens and hover-over-focus arbitration reuse the «Общие компоненты, темы и подсказки» (подэтап e) overlay.
