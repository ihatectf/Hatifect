# Соответствие пакетов собранным DLL
...
Следующий общий шаг — приёмка проверенного «Действия и их завершение»/alpha.43 от задачи UI и завершение физического Backspace при доступности пользователя. При повторении смены metadata verifier остановит feed; дальнейшая диагностика должна сохранить pack-time MSBuild properties и исходные артефакты, без автоматической перепаковки ради PASS.
