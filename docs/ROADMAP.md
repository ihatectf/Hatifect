...
Общая alpha.44 integration GQ [`e954c6d`](https://github.com/ihatectf/Hatifect/commit/e954c6db21e26e1a9546f3bd23fe77c1fa25f329) — **IN_PROGRESS**, пока локальная. Собственные C/G — PASS1466/1707 .NET +366 Python; P — PASS90 с восемью DLL, равными текущим producer outputs. [Точная привязка и оставшаяся native acceptance](Q01_ALPHA44_INTEGRATION.md). Следующий шаг — отдельный нативный Open/Follow fixture и проверка окончательной поставки; alpha.43 runtime evidence не переименовывается.
