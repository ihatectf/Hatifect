...
Следующий готовый шаг Q01 — сопоставить верхнюю полосу конечного кадра с реальным окном и проверить начальный viewport standalone. Физический ввод и полная визуальная матрица ещё не выполнены; полная Q01 этим не закрыта.
