...
Статус F20 — **IN_PROGRESS** после опубликованного F17-b `ece74db`. F20-a [6d0ac14](https://github.com/ihatectf/Hatifect/commit/6d0ac1407f70c70ccb03126d1ceea49f1caa6f58) добавляет диагностику у владельцев Core/Persistence/host и проверку предельных журналов на 32/128/256 грузах; точные проверки и границы — в [отчёте F20-a](ROADMAP-STATUS.md#f20-a-resource-diagnostics-and-retention-boundaries). Следующий готовый шаг — реальные измерения routing/dispatch/checkpoint/restore и receipt growth в фиксированном изолированном сценарии. D06 и полный F20 пока не закрыты; UI F18/F19 сохраняют свои зависимости.
...
Q01 — **IN_PROGRESS**: [новая проверка из терминала Codex](Q01_RUNTIME_BASELINE.md) выполнена на объединённой alpha.35 / `7a9e590`: UI/CA aggregate, fake Flow lifecycle/isolation и четыре отрицательных CA-сценария прошли; 620 кадров уложились в действующие бюджеты. Сохранён один FAIL неверно подготовленного absent fixture и его успешный повтор. [Bounded fix захвата](Q01_CAPTURE_FIX.md), [`85a786f`](https://github.com/ihatectf/Hatifect/commit/85a786f479895bd23046cf0d0f7ebc615cc90324), **DONE**: снимок делается после композиции world/UI, дополнительно сохраняется UI-слой; свежие C/G/P и aggregate/standalone runtime прошли. Сохраняются отдельные наблюдения верхней полосы конечного кадра и начального viewport; физический ввод и полная визуальная матрица не выполнены. Следующий bounded fix — standalone HUD-overlay с корректным world-ready fixture и проверкой изображения. Полная Q01 этим не закрыта.
