# U06-g semantic form-field help

Source: `f2794599df67e9786ae493e7a1450a24812a5f42` on local branch
`feature/u06-form-help`. This slice is local only and has not been pushed.
...
tooltip map introduced by U06-e; no second help channel or device-specific consumer text is added.
...
selection, layout, placement, theme tokens and frame construction continue to use the U06-e policy.
...
remaining theme/component families keep U06 `IN_PROGRESS`.
