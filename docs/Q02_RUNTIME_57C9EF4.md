# M3/Q02: exact runtime and installable candidate 57c9ef4
...
- Dependencies and first-run procedure: [Q02_ALPHA_INSTALL.md](Q02_ALPHA_INSTALL.md).

F13/F18/F19 имеют точную normalized runtime, visual, controller и CA coexistence evidence этого
состава, но physical input остаётся незакрытым. Поэтому Q02 остаётся **IN_PROGRESS** и архив нельзя
