...
def _working_name(run_id: str, scenario_id: str = "") -> str:
    ...
    return f"HatifectHarness{token}_4242424242" if scenario_id in {"flow.chest.roundtrip", "flow.chest.crash-after-save", "flow.chest.crash-after-delivery", "flow.chest.crash-after-unsaved-extraction", "flow.chest.crash-after-unsaved-delivery"} else f"HatifectHarness_{token}"
